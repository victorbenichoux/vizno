"use strict";const{useEffect:useEffect,useRef:useRef,useContext:useContext,createContext:createContext}=window.htmPreact,DependencyLoader=createContext({});function useDependencies({componentName:e,jsDependencies:n,cssDependencies:t}){const o=useContext(DependencyLoader),c=useRef(0==n.length),s=useRef(0==t.length);return useEffect((()=>{!0!==o.canRender[e]&&!0!==o.isLoadingDependencies.current[e]&&(o.isLoadingDependencies.current={...o.isLoadingDependencies.current,[e]:!0},n.forEach(((t,d)=>{const i=document.createElement("script");i.src=t,i.type="text/javascript",i.async=!1,i.onload=()=>{d==n.length-1&&(s.current&&o.setCanRender((n=>({...n,[e]:!0}))),c.current=!0)},document.head.appendChild(i)})),t.forEach(((n,d)=>{const i=document.createElement("link");i.href=n,i.rel="stylesheet",i.async=!1,i.onload=()=>{d==t.length-1&&(c.current&&o.setCanRender((n=>({...n,[e]:!0}))),s.current=!0)},document.head.appendChild(i)})))}),[e,t,o,n]),o.canRender[e]}const{html:html,useEffect:useEffect$1,useRef:useRef$1}=window.htmPreact,dictComponent={};function BokehContent({spec:e,content_uuid:n,external_js_dependencies:t,external_css_dependencies:o}){const c=useDependencies({componentName:"BokehContent",jsDependencies:t,cssDependencies:o}),s=useRef$1(null);return useEffect$1((()=>{s.current&&n&&c&&window.Bokeh.embed.embed_item(e,n)}),[s,n,c,e]),html`<div id="${n}" ref="${s}" />`}function VegaContent({spec:e,content_uuid:n,external_js_dependencies:t,external_css_dependencies:o}){const c=useRef$1(null),s=useDependencies({componentName:"VegaContent",jsDependencies:t,cssDependencies:o});return useEffect$1((()=>{c.current&&n&&s&&(e.config.width="container",e.config.height="container",window.vegaEmbed("#".concat(n),e).catch(console.error))}),[c,n,s,e]),html`<div id="${n}" ref="${c}" />`}function MarkdownText({text:e}){const n=useRef$1(null);return useEffect$1((()=>{window.snarkdown&&n.current&&(n.current.innerHTML=window.snarkdown(e))}),[e]),html`<div ref="${n}" />`}function SVGContainer({data:e}){const n=useRef$1(null);return useEffect$1((()=>{n.current&&(n.current.innerHTML=e)}),[e]),html`<div ref="${n}" />`}function TableContent({data:e,columns:n,content_uuid:t,external_js_dependencies:o,external_css_dependencies:c}){const s=useRef$1(null),d=useDependencies({componentName:"TableContent",jsDependencies:o,cssDependencies:c});return useEffect$1((()=>{s.current&&t&&d&&new window.Tabulator(`#${t}`,{data:e.map(((e,n)=>({id:n,...e}))),columns:n.map((e=>({field:e,title:e}))),layout:"fitColumns",height:"30vh"})}),[s,t,d,n,e]),html`<div ref=${s} id="${t}"></div>`}function SVGContent({data:e}){return html`<${SVGContainer} data="${e}" />`}function CodeContent({external_js_dependencies:e,external_css_dependencies:n,code:t,language:o}){console.log({external_js_dependencies:e,external_css_dependencies:n,code:t,language:o});const c=useDependencies({componentName:"CodeContent",jsDependencies:e,cssDependencies:n}),s=useRef$1(null);if(useEffect$1((()=>{s.current&&window.hljs.highlightBlock(s.current)})),c)return html`<pre><code ref=${s} class="language-${o}">${t}</code></pre>`}function LatexContent({external_js_dependencies:e,external_css_dependencies:n,text:t}){if(useDependencies({componentName:"LatexContent",jsDependencies:e,cssDependencies:n}))return customElements.define("latex-js",window.latexjs.LaTeXJSComponent),html`<latex-js baseURL="https://cdn.jsdelivr.net/npm/latex.js/dist/"
      >${t}</latex-js
    >`}function MathJaxContent({external_js_dependencies:e,external_css_dependencies:n,text:t}){const o=useDependencies({componentName:"MathJaxContent",jsDependencies:e,cssDependencies:n}),c=useRef$1(null);return useEffect$1((()=>{o&&window.MathJax&&window.MathJax.typeset((()=>c.current))})),html`<div ref=${c}>${t}</MathJax-js>`}function PlotlyComponent({content_uuid:e,spec:n,external_js_dependencies:t,external_css_dependencies:o}){const c=useDependencies({componentName:"PlotlyComponent",jsDependencies:t,cssDependencies:o}),s=useRef$1(null);return useEffect$1((()=>{c&&window.Plotly&&window.Plotly.react(e,n.data,n.layout)})),html`<div ref=${s} id=${e} />`}function FallbackContent({detected_type:e}){return html`<p class="vz-text">Unknown content type "${e}"</p>`}function VZCustomComponent({component:e,spec:n}){console.log("Preparing to render custom component:",e);const{component_module:t,external_js_dependencies:o,external_css_dependencies:c,...s}=n;return useDependencies({componentName:e,jsDependencies:[...o,t],cssDependencies:c})?html`<${window[e]} ...${s} />`:html`<p class="vz-text">
    ...
    <${MarkdownText} text=${n} />
  </div>`}function ViznoElement({element:e}){const{element_type:n}=e;return html$1`<div class="vz-element">
    ${"widget"===n?html$1` <${Widget} widgetSpec=${e} />`:"header"===n?html$1`<${Header} headerSpec=${e} />`:"text"===n?html$1`<${TextElement} textSpec=${e} />`:null}
  </div>`}const widthToPureClass=[null,"1-12","1-6","1-4","1-3","5-12","1-2","7-12","2-3","3-4","5-6","11-12","1-1"];function WidgetLayout({elements:e}){let n=[],t=0,o=[];for(let c of e)"header"!==c.element_type&&t+c.layout.width<=12&&!c.layout.newline?(n=[...n,c],t+=c.layout.width):(o=[...o,n],t=c.layout.width,n=[c]);return n.length&&(o=[...o,n]),html$1`${o.map((e=>html$1`<div class="pure-g">
    ...
    <div class="vz-body">
      ...
      ${t?html$1`<div class="vz-report-description vz-element">
            <${MarkdownText} text=${t} />
          </div>`:null}
